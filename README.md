...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=sanidhya2506&label=Profile%20Views&color=ff69b4&style=for-the-badge" alt="Profile views" />
</p>
...
What interests me most is not simply making software work, but asking:
...
**ML:** Supervised Learning • Unsupervised Learning • Feature Engineering • Model Evaluation • Recommendation Systems • NLP • TF-IDF • Cosine Similarity
...
**CS Foundations:** DSA • OOP • DBMS • Operating Systems • Computer Networks • System Design
...
**Why I built it:** To explore how technology can preserve lived experiences without turning sensitive stories into engagement-driven content.
...
Essay2Dating challenges swipe culture by removing profile photos entirely. Connections begin with **thoughts, writing and emotional clarity**, rather than appearance.

**Highlights**
- No swipes
- No profile photos
- No appearance-based filters
...
| **Click-Stream-DataPipeline** | Data pipelines and event / click-stream processing |
...
`Arrays` • `Strings` • `Hashing` • `Linked Lists` • `Stacks` • `Queues` • `Trees` • `Graphs` • `Recursion` • `Dynamic Programming` • `Greedy` • `Binary Search`
...
My goal is to understand the complete path:
...
A capstone / challenge-oriented concept exploring how intelligent systems can optimize diagnostic screening sequences under real-world resource constraints.

The core idea:

**Cognitive Tests → Blood Biomarkers → Selective MRI → PET**

The system considers factors such as diagnostic value, cost and resource availability rather than blindly sending every patient through the same expensive pathway.
...
I don't want to build technology simply because it can be built.
...
For me, good engineering is not only about **scale, speed and accuracy**.

It's also about **intent, responsibility and human impact.**
